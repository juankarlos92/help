<template>
    <div class="text-base text-black dark:text-white dark:bg-slate-900 layout_landing" :class="current_mode"
        ...
        <!-- Back To Top Start -->
        <a id="back-to-top" @click="topFunction" href="javascript:void(0)"
                ...
                <div class="flex justify-center items-center ">
                    <div class="w-80 h-96 bg-white rounded shadow-2xl">
                        <nav class="w-full bg-gray-900 rounded-tr rounded-tl flex justify-between items-center">
                            ...
                            <div class="flex items-center"> <i class="mdi mdi-video text-gray-300 mr-4"></i> <i
                                    class="mdi mdi-phone text-gray-300 mr-2"></i> <i
                                    class="mdi mdi-dots-vertical text-gray-300 mr-2"></i> </div>
                        </nav>
                        <div class="overflow-auto px-1 py-1 reverse__order" style="height: 19rem;" id="journal-scroll">

                            <div v-if="current_chat.messages && current_chat.messages.length"
                                v-for="(message, index) in current_chat.messages.slice().reverse()" :key="index"
                                class="flex items-end pr-4 mt-4"
                                v-bind:class="{ 'pt-3 pl-10 justify-end': !!message.contact_id }">
                                <img v-if="message.user_id && current_chat.participant.user" src="/images/svg/profile.svg"
                                ...
                                <span
                                    ...
                                    v-bind:class="{ 'ml-1 bg-gray-900 dark:bg-slate-800': !!message.user_id, 'bg-green-900': !!message.contact_id }">
                                    {{ message.message }}
                                </span>
                        ...
                        <div class="flex justify-between items-center p-1 bg-white chat_b_footer">
                            <div class="relative t__area">
                                ...
                                <input v-model="message" @keydown.enter.exact.prevent="sendMessage" type="text"
                            ...
                            <div class="w-8 h-8 rounded-full text-center items-center flex justify-center">
                                <button
                                    ...
                                    @click="sendMessage">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 252.07 169.78" fill="currentcolor">
                ...
                <div class="flex justify-center items-center ">
                    <div class="w-80 h-auto bg-white rounded shadow-2xl">
                        <nav class="w-full bg-gray-900 rounded-t flex flex-col items-center pt-3">
                            <Logo class="block mx-auto w-full max-w-xs fill-white" height="40" />
                            <p class="text-md font-medium text-gray-300 text-center p-3 mb-3 t_h_text">Let us know who you
                                are, and let's get talking.</p>
                        </nav>
                                    ...
                                    <form class="bg-white rounded px-8 pt-6 pb-8">
                                        <div class="flex justify-center mb-4">
                                            <div class="flex flex-col pr-2">
                                                ...
                                                <input v-model="init_user.firstName"
                                            ...
                                            <div class="flex flex-col pl-2">
                                                ...
                                                <input v-model="init_user.lastName"
                                                    class=" appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none"
                                        ...
                                        <div class="mb-6">
                                            ...
                                            <input v-model="init_user.email"
                                                class=" appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none"
                                                id="emailAddress" type="text" placeholder="Email address">
                                        </div>
                                        <div class="flex items-center">
                                            <button
