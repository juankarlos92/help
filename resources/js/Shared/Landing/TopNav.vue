        ...
        <div class="container">
            <div class="relative -mx-4 flex items-center justify-between">
                ...
                <div class="flex w-full items-center justify-end px-4">
                    ...
                    <!--                 {{ __('Home') }}</Link> -->
                    <!--             </li> -->
                    <!--             <li class="group relative" :class="{ 'active': active_menu === 'services' }" -->
                    <!--                 @click="active_menu = 'services'"> -->
                    <!--                 <Link :href="route('services')" -->
                    <!--                     class="ud-menu-scroll mx-8 flex py-2 text-base text-dark group-hover:text-primary lg:mr-0 lg:inline-flex lg:py-6 lg:px-0 lg:text-white lg:group-hover:text-white lg:group-hover:opacity-70"> -->
                    <!--                 {{ __('Services') }}</Link> -->
                    <!--             </li> -->
                    <!--             <li class="group relative" :class="{ 'active': active_menu === 'kb' }" -->
                    <!--                 @click="active_menu = 'kb'"> -->
                    <!--                 <Link :href="route('kb')" -->
                    <!--                     class="ud-menu-scroll mx-8 flex py-2 text-base text-dark group-hover:text-primary lg:mr-0 lg:inline-flex lg:py-6 lg:px-0 lg:text-white lg:group-hover:text-white lg:group-hover:opacity-70"> -->
                    <!--                 {{ __('Knowledge') }}</Link> -->
                    <!--             </li> -->
                    <!--             <li class="group relative" :class="{ 'active': active_menu === 'faq' }" -->
                    <!--                 @click="active_menu = 'faq'"> -->
                    <!--                 <Link :href="route('faq')" -->
                    <!--                     class="ud-menu-scroll mx-8 flex py-2 text-base text-dark group-hover:text-primary lg:mr-0 lg:inline-flex lg:py-6 lg:px-0 lg:text-white lg:group-hover:text-white lg:group-hover:opacity-70"> -->
                    <!--                 {{ __('FAQs') }}</Link> -->
                    <!--             </li> -->
                    <!--             <li class="group relative" :class="{ 'active': active_menu === 'blog' }" -->
                    <!--                 @click="active_menu = 'blog'"> -->
                    <!--                 <Link :href="route('blog')" -->
                    <!--                     class="ud-menu-scroll mx-8 flex py-2 text-base text-dark group-hover:text-primary lg:mr-0 lg:inline-flex lg:py-6 lg:px-0 lg:text-white lg:group-hover:text-white lg:group-hover:opacity-70"> -->
                    <!--                 {{ __('Blog') }}</Link> -->
                    <!--             </li> -->
                    <!--             <li class="group relative" :class="{ 'active': active_menu === 'contact' }" -->
                    <!--                 @click="active_menu = 'contact'"> -->
