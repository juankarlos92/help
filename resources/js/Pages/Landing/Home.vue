        ...
        <section v-if="html.sections[2].enable_ticket_section" id="ticketSubmit"
            ...
            <div class="container">
                <form class="card mt-2 p-4 rounded shadow-xl overflow-hidden" enctype="multipart/form-data"
                    ...
                    <div class="px-5 ">
                        <h1 class="py-5 text-center md:text-3xl text-2xl md:leading-normal leading-normal font-semibold">
                            {{
                                __('Create a ticket') }}
                        </h1>
                        ...
                        <div class="flex flex-wrap">
                            <text-input v-model="form.first_name" :error="form.errors.last_name"
                                class="pr-6 rtl:pr-0 rtl:pl-6 pb-5 md:col-span-6 lg:w-1/3" label="First name" />
                            <text-input v-model="form.last_name" :error="form.errors.last_name"
                                class="pr-6 rtl:pr-0 rtl:pl-6 pb-5 md:col-span-6 lg:w-1/3" label="Last name" />
                            <text-input v-model="form.email" :error="form.errors.email" class=" pb-5 md:col-span-6 lg:w-1/3"
                                label="Email Address" />
                            ...
                            <select-input v-model="form.type_id" :error="form.errors.type_id"
                                class="pr-6 rtl:pr-0 rtl:pl-6 pb-5 md:col-span-6 lg:w-1/3" label="Ticket type">
